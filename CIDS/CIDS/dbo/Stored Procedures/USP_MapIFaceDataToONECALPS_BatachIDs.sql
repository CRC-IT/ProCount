...
--exec [dbo].[USP_MapIFaceDataToONECALPS_BatachIDs] 'GasLoaderTrans'
CREATE PROCEDURE [dbo].[USP_MapIFaceDataToONECALPS_BatachIDs]
@SubIFace varchar(20)
AS
BEGIN TRY
...
BEGIN CATCH 
	...
	VALUES ( 'USP_MapIFaceDataToONECALPS_BatachIDs','StoredProcedure',@SubIFace,'Error while fetching the Oil or Gas Loader subscriptions data from IFace table',ERROR_MESSAGE(), ERROR_NUMBER(),ERROR_SEVERITY(), GETDATE(),HOST_NAME(), CURRENT_USER)
